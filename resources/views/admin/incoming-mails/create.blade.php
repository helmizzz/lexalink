<x-admin-layout>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <form method="POST" action="{{ route('admin.incoming-mails.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="reference_number" class="block mt-1 w-full" type="text" name="reference_number" :value="old('reference_number')" required autofocus />
                    ...
                    <div>
                        ...
                        <x-text-input id="mail_date" class="block mt-1 w-full" type="date" name="mail_date" :value="old('mail_date', date('Y-m-d'))" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="type" class="block mt-1 w-full" type="text" name="type" :value="old('type')" required placeholder="Misal: Panggilan, Gugatan, Pemberitahuan" />
                    ...
                    <div>
                        ...
                        <x-text-input id="sender" class="block mt-1 w-full" type="text" name="sender" :value="old('sender')" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="case_category" class="block mt-1 w-full" type="text" name="case_category" :value="old('case_category')" />
                ...
                <div>
                    ...
                    <x-text-input id="document_url" class="block mt-1 w-full" type="url" name="document_url" :value="old('document_url')" />
                ...
                <div class="flex items-center justify-end mt-4 space-x-4">
                    <a href="{{ route('admin.incoming-mails.index') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
                        Batal
                    </a>
                    <x-primary-button>
                        {{ __('Simpan Surat Masuk') }}
                    </x-primary-button>
                </div>
            </form>
        </div>
